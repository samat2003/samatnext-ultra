...
def run_benchmarks():
    modes = ["standard", "ue4", "ue8", "ue16", "ue32", "ue64", "ue128"]
    results = {}
    
    out_dir = ROOT / "results_1000_steps"
    out_dir.mkdir(exist_ok=True)

    print("Starting sequential 1000-step Tiny Shakespeare benchmarks...")
    ...
    print("\nAll sequential benchmarks completed successfully.")
